...
public class ByteFrameDrawableDecoder implements ResourceDecoder<ByteBuffer, FrameDrawable> {
    ...
    public FrameDrawableResource decode(
        ...
        try {
            ...
            FrameDrawable frameDrawable =
                    new FrameDrawable(context, frameDecoder, unitTransformation, width, height, firstFrame);

            return new FrameDrawableResource(frameDrawable);
        } finally {
