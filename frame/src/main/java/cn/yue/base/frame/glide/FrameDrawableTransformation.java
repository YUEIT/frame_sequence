...
public class FrameDrawableTransformation implements Transformation<FrameDrawable> {
    private final Transformation<Bitmap> wrapped;

    public FrameDrawableTransformation(Transformation<Bitmap> wrapped) {
        this.wrapped = Preconditions.checkNotNull(wrapped);
    }

    @NonNull
    @Override
    public Resource<FrameDrawable> transform(
            @NonNull Context context,
            @NonNull Resource<FrameDrawable> resource,
            int outWidth,
            int outHeight) {
        FrameDrawable drawable = resource.get();
    ...
    public boolean equals(Object o) {
        if (o instanceof FrameDrawableTransformation) {
            FrameDrawableTransformation other = (FrameDrawableTransformation) o;
