...
public class GifFrameDrawable extends Drawable
        implements FrameLoader.FrameCallback, Animatable, Animatable2Compat {
    ...
    GifFrameDrawable(FrameState state) {
        this.state = Preconditions.checkNotNull(state);
    }

    @VisibleForTesting
    GifFrameDrawable(FrameLoader frameLoader, Paint paint) {
        this(new FrameState(frameLoader));
        this.paint = paint;
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (currentFrame != null && !currentFrame.isRecycled()) {
            canvas.drawBitmap(currentFrame, destRect, getBounds(), getPaint());
        }
    }
    ...
    static final class FrameState extends ConstantState {
        @VisibleForTesting
        final FrameLoader frameLoader;

        FrameState(FrameLoader frameLoader) {
        ...
        public Drawable newDrawable() {
            return new GifFrameDrawable(this);
        }
